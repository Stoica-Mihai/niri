...
impl From<niri_ipc::Action> for Action {
    fn from(value: niri_ipc::Action) -> Self {
        match value {
            ...
            niri_ipc::Action::PeekColumnLeft {} => Self::PeekColumnLeft,
            niri_ipc::Action::PeekColumnRight {} => Self::PeekColumnRight,
            niri_ipc::Action::PeekColumnFirst {} => Self::PeekColumnFirst,
            niri_ipc::Action::PeekColumnLast {} => Self::PeekColumnLast,
            niri_ipc::Action::PeekEnd {} => Self::PeekEnd,
